...
class BrokerConstructorMethodSpockTest extends SpockRollbackTestAbstractClass {
    ...
    def success() {
        ...
        def broker = new Broker(BROKER_CODE, BROKER_NAME,NIF, BROKER_IBAN,
    ...
    def 'invalid arguments'() {
        ...
        null        | BROKER_NAME | NIF                  | BROKER_IBAN | 'null code'
        ""          | BROKER_NAME | NIF                  | BROKER_IBAN | 'empty code'
        "   "       | BROKER_NAME | NIF                  | BROKER_IBAN | 'blank code'
        BROKER_CODE | null        | NIF                  | BROKER_IBAN | 'null name'
        BROKER_CODE | ""          | NIF                  | BROKER_IBAN | 'empty name'
        BROKER_CODE | "    "      | NIF                  | BROKER_IBAN | 'blank name'
        ...
        BROKER_CODE | BROKER_NAME | NIF                  | null        | 'null iban'
        BROKER_CODE | BROKER_NAME | NIF                  | ""          | 'empty iban'
        BROKER_CODE | BROKER_NAME | NIF                  | "   "       | 'blank iban'
    }
