...
class BrokerPersistenceTest extends SpockPersistenceTestAbstractClass{
    ...
    def REF_ONE = "ref1"
    def begin = LocalDate.parse("2016-01-06")
    ...
    def thenAssert() {
        ...
        assert adventure.getMargin() == Double.parseDouble("0.3")
        assert adventure.getCurrentAmount() == Double.parseDouble("0.0")
