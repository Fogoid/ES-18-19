...
class AdventureConstructorMethodSpockTest extends SpockRollbackTestAbstractClass {
    ...
    def 'success'() {
        ...
        def adventure = new Adventure(broker, begin, end, client, margin, HotelInterface.Type.SINGLE)
    ...
    def 'invalid arguments'() {
        ...
        new Adventure(brok, begin, end, client, margin, HotelInterface.Type.SINGLE)
