...
class AdventureSequenceSpockTest extends SpockRollbackTestAbstractClass {
    ...
    def 'success sequence with car #car, hotel #hotel'() {
        ...
        def adventure = new Adventure(broker, ARRIVAL, end, client, MARGIN, car, CarInterface.Type.CAR ,HotelInterface.Type.SINGLE)
    ...
    def 'unsuccess sequence fail car'() {
        ...
        def adventure = new Adventure(broker, ARRIVAL, ARRIVAL, client, MARGIN, true, CarInterface.Type.CAR, HotelInterface.Type.SINGLE)
        and: 'an activity reservation'
        activityInterface.reserveActivity(_) >> bookingActivityData
        and: 'a car exception'
    ...
    def 'unsuccess sequence fail payment'() {
        given: 'an adventure with rent vehicle'
        def adventure = new Adventure(broker, ARRIVAL, DEPARTURE, client, MARGIN, true, CarInterface.Type.CAR, HotelInterface.Type.SINGLE)
        and: 'an activity reservation'
        activityInterface.reserveActivity(_) >> bookingActivityData
        and: 'a room booking'
        hotelInterface.reserveRoom(_) >> bookingRoomData
