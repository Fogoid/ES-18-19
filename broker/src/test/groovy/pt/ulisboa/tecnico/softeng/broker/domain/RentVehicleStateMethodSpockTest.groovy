...
class RentVehicleStateMethodSpockTest extends SpockRollbackTestAbstractClass {
    ...
    def populate4Test() {
        ...
        def broker = new Broker("BR01", "eXtremeADVENTURE", NIF, BROKER_IBAN, new ActivityInterface(), new HotelInterface(), carInterface, new BankInterface(), taxInterface)
        def client = new Client(broker, CLIENT_IBAN, CLIENT_NIF, DRIVING_LICENSE, AGE)
        adventure = new Adventure(broker, BEGIN, END, client, MARGIN, HotelInterface.Type.SINGLE)
    ...
    def 'successRentVehicle'() {
        ...
        carInterface.rentCar(CarInterface.Type.CAR, DRIVING_LICENSE, NIF, BROKER_IBAN,
    ...
    def 'exceptions rentCar'() {
        ...
        iterations * carInterface.rentCar(CarInterface.Type.CAR, DRIVING_LICENSE, NIF, BROKER_IBAN,
